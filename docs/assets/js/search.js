...
typedoc.search.data = {
  ...
  rows: [
    ...
    { id: 11, kind: 1, name: "@tomato-js/path", url: "modules/_tomato_js_path.html", classes: "tsd-kind-external-module" },
    {
      id: 12,
      kind: 64,
      name: "getSearch",
    ...
    { id: 16, kind: 1, name: "@tomato-js/shared", url: "modules/_tomato_js_shared.html", classes: "tsd-kind-external-module" },
    {
      id: 17,
      kind: 64,
      name: "isType",
